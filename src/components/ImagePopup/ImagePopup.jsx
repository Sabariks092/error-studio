      ...
      {isOpen && item && (
        ...
        >
          ...
          <motion.button
            ...
            className="absolute left-6 text-white bg-black/30 backdrop-blur-xs  p-2 hover:text-gray-300"
          >
            <ChevronLeft size={48} />
          </motion.button>
          ...
          <motion.button
            onClick={onNext}
            className="absolute right-6 text-white hover:text-gray-300 bg-black/30 p-2 backdrop-blur-xs"
            style={{borderRadius:"100%"}}
          >
