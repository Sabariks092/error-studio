          ...
          <Div className="col-lg-8">
            ...
            <Div className="cs-post cs-style2">
              <Div className="cs-post_thumb cs-radius_15">
                <img src={post5} alt="Post" className="w-100 cs-radius_15" />
              </Div>
              <Div className="cs-post_info">
                ...
                <Div className="row">
                  <Div className="col-md-6">
                    <img src={blogDetailsImg1} alt="Blog Details" className="cs-radius_15 w-100" />
                    <Div className="cs-height_45 cs-height_lg_45" />
                  </Div>
                  <Div className="col-md-6">
                    <img src={blogDetailsImg2} alt="Blog Details" className="cs-radius_15 w-100" />
                    <Div className="cs-height_45 cs-height_lg_45" />
                  </Div>
                </Div>
